...
\subsection{Million Song Dataset Subset}
...
In addition to the list above, the Neural Networks approach also utilized a feature called "artist terms," which is simply a list of tags (genres) for each song.
\\
\\
...
\label{sec:references}
 ...
 references.}
\smallHorizontalLine
\href{http://notes.variogr.am/post/37675885491/how-music-recommendation-works-and-doesnt-work}{How music recommendation works - and doesn't work} - Brian Whitman

...
In addition to the list above, the Neural Networks approach also utilized a feature called "artist terms," which is simply a list of tags, which in our case are analogous to genres, for each song. 
\\
\\
